...
# ───────────────────────────────────────────────────────────────
corr_yearly_ozone <- ozonewt_daily_complete %>% 
...
# ───────────────────────────────────────────────────────────────
p_lines_ozone <- ggplot(corr_yearly_ozone, aes(year, r, colour = pair)) +
  ...
  labs(
    title = "Year-wise Pearson correlation of population-weighted Ozone",
...
# 3.  Save as PDF  ----------------------------------------------
# ───────────────────────────────────────────────────────────────
ggsave("ozone_income_correlations_2000-2023.pdf",
       plot   = p_lines_ozone,
       width  = 8,
       height = 5)
