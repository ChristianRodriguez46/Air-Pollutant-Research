...
# ───────────────────────────────────────────────────────────────
corr_yearly_pm25 <- pm25wt_daily_complete %>% 
...
# ───────────────────────────────────────────────────────────────
p_lines_pm25 <- ggplot(corr_yearly_pm25, aes(year, r, colour = pair)) +
  ...
  labs(
    title = "Year-wise Pearson correlation of population-weighted PM2.5",
...
# 3.  Save as PDF  ----------------------------------------------
# ───────────────────────────────────────────────────────────────
ggsave("pm25_income_correlations_2000-2023.pdf",
       plot   = p_lines_pm25,
       width  = 8,
       height = 5)
