...
# ───────────────────────────────────────────────────────────────
annual_means <- no2wt_daily_complete %>% 
...
# 3.  Save to CSV  ----------------------------------------------
# ───────────────────────────────────────────────────────────────
write_csv(disp_year, "annual_disparities_low_vs_high_no2_2000_2023.csv")

cat("✓ CSV written to 'annual_disparities_low_vs_high_no2_2000_2023.csv'\n")

library(ggplot2)
library(readr)   # if you read disp_year from disk

# If disp_year is already in memory, skip this line
# disp_year <- read_csv("annual_disparities_low_vs_high_no2_2000_2023.csv")
...
# ───────────────────────────────────────────────────────────────
ggsave("no2_abs_disparity_2000_2023.pdf", plot = p_abs,
       width = 7, height = 4.5, units = "in")

ggsave("no2_rel_disparity_2000_2023.pdf", plot = p_rel,
       width = 7, height = 4.5, units = "in")
