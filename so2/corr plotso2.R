...
# ───────────────────────────────────────────────────────────────
corr_yearly_so2 <- so2wt_daily_complete %>% 
...
# ───────────────────────────────────────────────────────────────
p_lines_so2 <- ggplot(corr_yearly_so2, aes(year, r, colour = pair)) +
  ...
  labs(
    title = "Year-wise Pearson correlation of population-weighted SO2",
...
# 3.  Save as PDF  ----------------------------------------------
# ───────────────────────────────────────────────────────────────
ggsave("so2income_correlations_2000-2023.pdf",
       plot   = p_lines_so2,
       width  = 8,
       height = 5)
